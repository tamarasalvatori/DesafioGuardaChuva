...
{
    class InserirClienteIncompletoPage
    {
        ...
        public InserirClienteIncompletoPage(IWebDriver driver)
        {
            this.driver = driver;
        }

        public void PreencheIdentPessoaCpfIncompleto(string nome, string email, string nascimento)
        {
        ...
        public void PreencheIdentPessoaCpfInvalido(string cpf, string nome, string email, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaNomeIncompleto(string cpf, string email, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaNascimentoIncompleto(string cpf, string nome, string email)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaEmailIncompleto(string cpf, string nome, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaEmailInvalido(string cpf, string nome, string email, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaGeneroIncompleto(string cpf, string nome, string email, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
        ...
        public void PreencheIdentPessoaEstCivilIncompleto(string cpf, string nome, string email, string nascimento)
        {
            selecionaTipo = driver.FindElement(By.Id(idTipoPessoa));
            selecionaTipo.Click();
